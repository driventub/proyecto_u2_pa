...
public class Pasaporte {
    ...
    @OneToOne
    @JoinColumn(name = "pasa_ciud_id")
    private CiudadanoP ciudadano;
    ...
    public CiudadanoP getCiudadano() {
        return ciudadano;
    }



    public void setCiudadano(CiudadanoP ciudadano) {
    ...
    public String toString() {
        return "Pasaporte [ fechaCaducidad=" + fechaCaducidad + ", fechaEmision="
                + fechaEmision + ", id=" + id + ", numero=" + numero + "]";
    }
